...
# Description:
# This script gets the primers form primal scheme into a single file with the names of the genes. Only one length of overlap should be used.
#
# input: the directory to search for primers generated by primalscheme
# output: a file to list all the primers
#
